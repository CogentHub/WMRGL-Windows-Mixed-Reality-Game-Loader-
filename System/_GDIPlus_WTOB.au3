...
;=======================================================================================
Func _GDIPlus_WTOB($sIn, $sText, $fName = "Impact", $fSize = 11, $iX = -1, $iY = -1, $iAlignX = 2, $iAlignY = 2, $iFColor = 0xFFFFFFFF, $ebg = True, $save = False, $sFilename = _PathFull("HomeLoader\WTOB.png", @AppDataDir), $iJPGQ = 90, $draw_bgrect = False, $iDrawBGRect_c = 0xFF808080)
